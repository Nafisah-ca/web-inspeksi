...
<?php $__env->startSection('title', 'CMS Konten Website'); ?>
<?php $__env->startSection('page-title', 'CMS Konten Website'); ?>
    ...
    <div class="card p-5 hover:shadow-md transition-shadow">
        <div class="flex items-start justify-between mb-4">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 <?php echo e($bg); ?> <?php echo e($tc); ?> rounded-xl flex items-center justify-center">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($path); ?>"/>
                    </svg>
                </div>
                <div>
                    <h3 class="font-semibold text-gray-900 text-sm"><?php echo e($label); ?></h3>
                    <p class="text-xs text-gray-400"><?php echo e($total); ?> field konten</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-4">
            <div class="flex justify-between text-xs text-gray-500 mb-1">
                <span>Terisi</span>
                <span><?php echo e($filled); ?>/<?php echo e($total); ?> field</span>
            </div>
            <div class="w-full bg-gray-100 rounded-full h-1.5">
                <div class="h-1.5 rounded-full transition-all <?php echo e($pct === 100 ? 'bg-green-500' : ($pct > 50 ? 'bg-blue-500' : 'bg-yellow-400')); ?>"
                     style="width: <?php echo e($pct); ?>%"></div>
            </div>
        </div>

        
        <?php if($sectionItems->isNotEmpty()): ?>
        <div class="bg-gray-50 rounded-xl p-3 mb-4 space-y-1">
            <?php $__currentLoopData = $sectionItems->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="flex gap-2 text-xs">
                <span class="text-gray-400 shrink-0 w-24 truncate"><?php echo e($item->label); ?></span>
                <span class="text-gray-600 truncate"><?php echo e($item->value ?: '—'); ?></span>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if($sectionItems->count() > 2): ?>
            <p class="text-xs text-gray-400">+<?php echo e($sectionItems->count() - 2); ?> field lainnya</p>
            <?php endif; ?>
        </div>
        <?php endif; ?>

        <a href="<?php echo e(route('admin.site-content.edit', $key)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-inspeksi\web-inspeksi\resources\views/admin/site-content/index.blade.php ENDPATH**/ ?>