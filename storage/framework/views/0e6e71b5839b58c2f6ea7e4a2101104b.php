    ...
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 flex flex-col transform transition-transform duration-200 ease-in-out
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="<?php echo e(route('admin.bookings.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.bookings.*') && !request()->routeIs('admin.results.*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <a href="<?php echo e(route('admin.results.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.results.*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                Hasil Inspeksi
                <?php $doneCount = \App\Models\InspectionResult::count(); ?>
                <?php if($doneCount > 0): ?>
                    <span class="ml-auto bg-green-100 text-green-700 text-xs font-semibold px-2 py-0.5 rounded-full"><?php echo e($doneCount); ?></span>
                <?php endif; ?>
            </a>
            ...
            <a href="<?php echo e(route('admin.site-content.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admin.site-content.*') ? 'active' : ''); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<?php /**PATH C:\laragon\www\web-inspeksi\web-inspeksi\resources\views/layouts/admin.blade.php ENDPATH**/ ?>