...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    ...
    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $count, $color, $icon]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card p-5">
        <div class="flex items-center justify-between mb-3">
            <p class="text-sm font-medium text-gray-500"><?php echo e($label); ?></p>
            <div class="w-9 h-9 rounded-lg flex items-center justify-center bg-<?php echo e($color); ?>-100">
                <svg class="w-5 h-5 text-<?php echo e($color); ?>-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($icon); ?>"/>
                </svg>
            </div>
        </div>
        <p class="text-3xl font-bold text-gray-900"><?php echo e($count); ?></p>
        ...
        <div class="flex items-end gap-2 h-36" x-data>
            ...
            <div class="flex-1 flex flex-col items-center gap-1">
                ...
                <div class="w-full bg-blue-100 rounded-t-md transition-all"
                     style="height: <?php echo e(max($height, 4)); ?>%"
                     title="<?php echo e($day['date']); ?>: <?php echo e($day['count']); ?> booking">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500"><?php echo e($booking->vehicle->brand); ?> <?php echo e($booking->vehicle->model); ?> · <?php echo e($booking->package->name); ?></p>
                        </div>
                    </div>
        ...
        <div class="divide-y divide-gray-50">
            ...
            <a href="<?php echo e(route('admin.bookings.show', $booking)); ?>"
               class="flex items-center justify-between px-5 py-3 hover:bg-gray-50 transition-colors">
                <div>
                    <p class="text-sm font-medium text-gray-900"><?php echo e($booking->booking_code); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($booking->user->name); ?> · <?php echo e($booking->booking_date->format('d M Y')); ?></p>
                </div>
                <span class="badge-<?php echo e($booking->status_color); ?>"><?php echo e($booking->status_label); ?></span>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\inspeksi\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>