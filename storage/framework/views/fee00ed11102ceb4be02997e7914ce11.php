...
<div class="min-h-[80vh] flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 text-sm mt-1">Sudah punya akun? <a href="<?php echo e(route('login')); ?>" class="text-blue-600 font-medium hover:underline">Masuk</a></p>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web-inspeksi\web-inspeksi\resources\views/auth/register.blade.php ENDPATH**/ ?>