    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100">
            ...
            <div class="py-6 px-4 text-center">
                <p class="text-2xl font-bold text-gray-900"><?php echo e($icon); ?> <?php echo e($val); ?></p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            ...
            <div class="card p-6 hover:shadow-md transition-shadow relative <?php echo e($i === 1 ? 'border-blue-500 border-2 ring-4 ring-blue-50' : ''); ?>">
                ...
                <?php endif; ?>
                <div class="mb-4">
                    <div class="w-10 h-10 rounded-xl mb-3 flex items-center justify-center <?php echo e(['bg-green-100 text-green-600', 'bg-blue-100 text-blue-600', 'bg-purple-100 text-purple-600'][$i]); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<section class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$num, $title, $desc, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="text-center">
                <div class="inline-flex items-center justify-center w-14 h-14 <?php echo e($color); ?> text-white text-xl font-bold rounded-2xl mb-4">
                    <?php echo e($num); ?>
